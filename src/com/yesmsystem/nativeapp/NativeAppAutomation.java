...
public class NativeAppAutomation {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException {
		...
		//cont-desc
		driver.findElementByAccessibilityId("Enter an e-mail address or username").sendKeys("bala@gmail.com");
		
		//xpath for cont-desc
		driver.findElementByXPath("//*[@content-desc='Password']").sendKeys("!ew3333");
		Thread.sleep(3000);
		//driver.findElementByXPath("//*[@text='Sign in']").click();		
